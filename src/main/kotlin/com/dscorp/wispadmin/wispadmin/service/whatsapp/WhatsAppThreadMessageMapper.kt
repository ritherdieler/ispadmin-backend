...
object WhatsAppThreadMessageMapper {
    ...
    fun WhatsAppInboundMessage.toThreadMessage() = WhatsAppThreadMessageDto(
        ...
        hasMedia = inboundHasMedia(this) && mediaPurgedAt == null && !mediaStoredPath.isNullOrBlank(),
        mediaExpired = mediaPurgedAt != null,
        mediaId = id,
    ...
    fun WhatsAppMessageLog.toThreadMessage(display: WhatsAppTemplateDisplayService) = WhatsAppThreadMessageDto(
        ...
        hasMedia = outboundHasMedia(this) && deletedAt == null && mediaPurgedAt == null && !mediaStoredPath.isNullOrBlank(),
        mediaExpired = mediaPurgedAt != null,
        mediaId = id.takeIf { outboundHasMedia(this) && deletedAt == null && mediaPurgedAt == null },
        mediaMimeType = mediaMimeType,
