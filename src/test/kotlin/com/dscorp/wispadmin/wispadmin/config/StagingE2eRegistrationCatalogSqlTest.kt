...
class StagingE2eRegistrationCatalogSqlTest {
    ...
    fun seed_copies_registration_catalog_from_prod() {
        ...
        assertTrue(sql.contains("INSERT INTO ispadmin_staging.tr069_model_profile"))
        assertTrue(sql.contains("FROM ispadmin.tr069_model_profile"))
        assertTrue(sql.contains("UPDATE ispadmin_staging.tr069_model_profile"))
