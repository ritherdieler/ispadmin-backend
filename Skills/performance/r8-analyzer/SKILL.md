---
name: r8-analyzer
description: Directrices de optimización de rendimiento y reglas de optimización de código R8
globs:
  - "src/main/kotlin/**"
---
...
- Configura las reglas de R8 y ProGuard de manera eficiente para evitar la eliminación de código reflexivo.
- Optimiza el uso de memoria evitando la creación redundante de objetos en bucles.
- Prioriza estructuras de datos eficientes y colecciones optimizadas para evitar retrasos en el hilo de ejecución.
