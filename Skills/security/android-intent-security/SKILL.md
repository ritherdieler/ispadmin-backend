...
description: Reglas de seguridad informática, cifrado HTTPS y manejo seguro de almacenamiento de datos
globs:
  - "src/main/kotlin/**"
---
...
- Garantiza que todos los endpoints expuestos requieran conexiones cifradas TLS/HTTPS.
- Configura e implementa de manera estricta el cifrado en el almacenamiento de credenciales y tokens de acceso.
- Valida y sanea de forma obligatoria las cabeceras HTTP de origen (CORS) para evitar ataques de inyección.
