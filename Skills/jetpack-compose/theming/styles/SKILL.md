---
name: styles
description: Reglas de estabilidad de estados y diseño de interfaces modernas adaptativas
globs:
  - "src/main/kotlin/**"
---
...
- Maneja de forma estricta la inmutabilidad en los estados de los contenedores de datos.
- Evita de forma rigurosa las recomposiciones innecesarias o el cálculo manual de dimensiones fijas.
- Separa la lógica de negocio del árbol de renderizado de la UI para garantizar un rendimiento óptimo.
