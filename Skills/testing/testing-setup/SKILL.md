---
name: testing-setup
description: Estructuración de suites de pruebas unitarias robustas y mockeo de datos asíncronos
globs:
  - "src/main/kotlin/**"
---
...
- Diseña las suites de pruebas utilizando esquemas que aíslen por completo los componentes (Mocks).
- Emplea controladores de prueba asíncronos (TestDispatcher) para validar la ejecución de corrutinas.
- Estructura las pruebas bajo el patrón Arrange-Act-Assert garantizando la verificación de caminos de éxito y de error.
