...
class SubscriptionController(
    ...
    private val subscriptionAcsLinkService: com.dscorp.wispadmin.wispadmin.service.genieacs.SubscriptionAcsLinkService,
    ...
    fun linkSubscriptionAcs(@RequestBody request: SubscriptionAcsLinkRequest): ResponseEntity<Any> {
        ...
        val result = subscriptionAcsLinkService.link(deviceId, request.dryRun)
    ...
    fun listAcsGhosts(): ResponseEntity<Any> {
        return ResponseEntity.ok(subscriptionAcsLinkService.listGhosts())
    }
    ...
    fun deleteAcsGhost(@RequestBody request: SubscriptionAcsLinkRequest): ResponseEntity<Any> {
        ...
        return try {
            val deleted = subscriptionAcsLinkService.deleteGhost(deviceId)
