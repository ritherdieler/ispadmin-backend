...
class HealthEvidenceReader(
    private val directory: SubscriptionDirectoryPort, private val identity: IdentityService,
    ...
    fun requireExists(id: Int) {
        if(!directory.exists(id)) throw NoSuchElementException("Suscripción inexistente")
    }
