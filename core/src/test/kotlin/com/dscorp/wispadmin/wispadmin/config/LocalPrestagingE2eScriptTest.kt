...
class LocalPrestagingE2eScriptTest {
    ...
    fun e2e_script_targets_local_prestaging_core_and_local_acs() {
        ...
        assertTrue(script.contains("GATEWAY_BASE:-http://127.0.0.1:8082/ispadmin"), script)
        assertTrue(script.contains("ACS_BASE:-http://127.0.0.1:8082/ispadmin"), script)
        assertFalse(script.contains("http://127.0.0.1:8090/ispadmin-acs"), script)
        assertFalse(script.contains("http://127.0.0.1:8080/ispadmin"), script)
