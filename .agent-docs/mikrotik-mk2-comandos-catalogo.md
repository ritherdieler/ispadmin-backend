...
| `POST /rest/ppp/secret/add {"name":"gf4321","profile":"GF-200-200","service":"pppoe","password":"…"}` | Alta del secret con el perfil del plan | `PppoeManagerService.ensureSecret` | **Sin** `remote-address`: el secret lo sobreescribiría y anularía el pool |
